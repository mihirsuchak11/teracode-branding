        ...
        ...(released
          ? {
              offers: {
                ...
                description:
                  "$29 or ₹2,999 per extra connected repository per month. The first repository in an organization is free forever. Inference is billed by your own provider. Checkout is Razorpay hosted (USD or INR).",
              },
            }
          : {}),
      },
