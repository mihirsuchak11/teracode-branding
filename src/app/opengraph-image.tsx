...
export const alt = "TeraCode — BYOK AI code review";
    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
            ...
            alt=""
          />
          <div style={{ fontSize: 40, color: "#fafaf9", letterSpacing: -1 }}>TeraCode</div>
        </div>

        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 86, color: "#fafaf9", letterSpacing: -3, lineHeight: 1.05 }}>
            Ship faster. Ship safer.
          </div>
          <div style={{ display: "flex", fontSize: 30, color: "#a6a09b", marginTop: 26 }}>
            An AI review board on every pull request — BYOK, on your own API keys.
          </div>
        </div>

        <div style={{ display: "flex", gap: 40, fontSize: 24, color: "#79716b" }}>
          <div style={{ display: "flex", color: "#10ec90" }}>$0 markup</div>
          <div style={{ display: "flex" }}>No per-seat licences</div>
